...
func ejecutoLambda(ctx context.Context, request events.APIGatewayProxyRequest) (*events.APIGatewayProxyResponse, error) {
	...
	path := strings.Replace(request.PathParameters["twitter"], os.Getenv("UrlPrefix"), "", -1) //Esto lo que hace es eliminar el prefijo de la ruta que le pasamos en el array para que la ruta quede limpia
